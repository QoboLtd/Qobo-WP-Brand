...
class QBDEVBY_Widget extends WP_Widget {
    ...
    function form( $instance ) {
      ...
      ?>
      <p>
        <input class="widefat" id="<?php echo $this->get_field_id('override_settings'); ?>" name="<?php echo $this->get_field_name('override_settings'); ?>" type="checkbox" value="1" <?php if($override_settings) echo 'checked=""'; ?> />
