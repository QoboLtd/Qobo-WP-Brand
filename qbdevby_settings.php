            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    <tr valign="top"><th scope="row">Title</th>
                        <td><input type="text" name="<?php echo self::OPTION_NAME?>[title]" value="<?php echo $options['title']; ?>" /></td>
                    </tr>
                    <tr valign="top"><th scope="row">Text</th>
                        <td><input type="text" name="<?php echo self::OPTION_NAME?>[text]" value="<?php echo $options['text']; ?>" /></td>
                    </tr>
                    <tr valign="top"><th scope="row">Text Style</th>
                        <td><input type="text" name="<?php echo self::OPTION_NAME?>[text_style]" value="<?php echo $options['text_style']; ?>" /></td>
                    </tr>
                    <tr valign="top"><th scope="row">Style</th>
                        <td><input type="text" name="<?php echo self::OPTION_NAME?>[style]" value="<?php echo $options['style']; ?>" /></td>
                    </tr>
                    <tr valign="top"><th scope="row">Light colour icon</th>
                        <td><input type="checkbox" name="<?php echo self::OPTION_NAME?>[light_colour_icon]" value="1" <?php if($options['light_colour_icon']) echo 'checked=""'; ?> /></td>
                    </tr>
                    <tr valign="top"><th scope="row">Link</th>
                        <td><input type="text" name="<?php echo self::OPTION_NAME?>[link]" value="<?php echo $options['link']; ?>" /></td>
                    </tr>
                    <tr valign="top"><th scope="row">Footer</th>
                        <td><input type="checkbox" name="<?php echo self::OPTION_NAME?>[footer]" value="1" <?php if($options['footer']) echo 'checked=""'; ?> /></td>
                    </tr>
                </table>
